...
import {NAVIGATION} from "../../components/layout/header/header.js";
 ...
 const Single = ({info})=>{
    return <li style={{transitionDelay:(Object.entries(NAVIGATION).length+2)/5+"s"}} >   <a rel="noreferrer"  title={info.alt} target={"_blank"} href={info.link}> <img loading="lazy" src={info.img} alt={info.alt}/>   </a>  </li>
}
