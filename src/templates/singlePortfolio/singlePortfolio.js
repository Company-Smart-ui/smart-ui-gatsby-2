                ...
                <div className="wrap">
                    <div className="left">
                        ...
                        <div className="block modified">
                            ...
                            <p>https://<wbr/>torontocannabisauthority.ca/</p>
                        </div>
                        <div className="block modified">
            ...
            <div className="wrap">
                <div className="left">
                    <div className="block">
                        ...
                        <p>Завдання, висунуте Toronto Cannabis Authority, було таким: «У 2021 році ми матимемо найкращий у світі веб-сайт з продажу канабісу». З точки зору вмісту, структури та загального використання, розробити веб-сайт у таким чином, щоб він дуже добре відображав бренд, технології та діяльність, водночас залишаючись провідним у сфері  комерції з амбітними цілями.</p>
                    </div>
                    <div className="block">
                        <h3 className="subtitle">НАШ ПІДХІД</h3>
                        <p>Завдання було амбітним, а завдання попереду – складним. Ми зібрали команду проекту з різними наборами навичок для дослідження, мозкового штурму, створення, ітерації та виконання з метою створення модельного веб-сайту в галузі. Щоб максимізувати позитивну взаємодію з користувачем, окрім макета, оптимізованого для мобільних пристроїв, і дизайну, орієнтованого на взаємодію з користувачем, ми збагатили веб-сайт низкою модних функцій, які гармонійно працюють разом. Такі як :</p>
                        <ul>
                            <li>- Персоналізовані пропозиції, сповіщення та купони.</li>
                            <li>- Інструмент рекомендації продукту, який допомагає клієнтам знайти потрібний продукт відповідно до їхніх потреб без використання будь-яких технічних термінів.</li>
                            <li>- Розумне попередньо визначене порівняння продуктів, щоб визначити різницю без зусиль.</li>
                        </ul>
                    </div>
                </div>
                <div className="right">
